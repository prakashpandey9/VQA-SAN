...
def download_vqa():
    ...
    print ('Downloading VQA Questions Dataset')
    ...
    print ('Downloading VQA Annotations Dataset')
    ...
    print ('Unzipping Questions/Annotations Files')
...
def main(params):
    ...
    '''
    Put the VQA data into single json file, where [[Question_id, Image_id, Question, 
